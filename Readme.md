...
# Parsing + Configuration Script – DF701 - Rev. A

This **Parsing + Configuration** script is designed for the **DF701** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – DF701 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **DF701** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
